...
export const Advantages = () => {
    return (
      <div id="getting-started" className="relative isolate">
        ...
        <div className="mt-5 pl-9 mb-[-5%]">
        <h1 className="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Advantages</span> @Apex University</h1>
        </div>
          ...
          <ul role="list" className="-mt-6 divide-y divide-gray-900/5 border-b border-gray-900/5">
            {AdvantagesList &&
              AdvantagesList.map((item, itemIdx) => (
                <li key={`section-even-${itemIdx}`} className="relative flex gap-x-6 py-6 px-12 hover:bg-gray-50">
